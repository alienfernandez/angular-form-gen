...
Drag and drop dynamic bootstrap forms with angular. Originally from angular-form-gen by McNull/angular-form-gen (https://github.com/McNull/angular-form-gen)
...
```
$ bower --save install angular-form-generator
```
