/*!
   angular-form-generator v0.3.0
   (c) 2017 Adriel Acosta https://github.com/alienfernandez/angular-form-generator
   License: MIT
*/
(function(angular) {
...
fg.config(["fgConfigProvider", "FgField", function (fgConfigProvider, FgField) {
    ...
    var categories = {
        ...
        'Checkbox fields': [
            ...
            new FgField('if-yes', {nolabel: true, detailsYes: "detailsYes"}),
        ...
        'Select input fields': [
            ...
            new FgField('datetime', {displayName: 'DateTime Picker'}),
            new FgField('date', {displayName: 'Date Picker'})
        ]
    };
